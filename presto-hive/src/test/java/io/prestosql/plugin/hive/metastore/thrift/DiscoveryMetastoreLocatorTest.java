...
public class DiscoveryMetastoreLocatorTest
{
    ...
    private static final DiscoveryMetastoreConfig CONFIG_WITH_FALLBACK_WITH_USER = new DiscoveryMetastoreConfig()
            .setMetastoreUris(Joiner.on(',').join(DEFAULT_URI, FALLBACK_URI, FALLBACK2_URI))
            .setMetastoreUsername("presto");

    private static final DiscoveryMetastoreConfig CONFIG_WITHOUT_FALLBACK_WITH_USER = new DiscoveryMetastoreConfig()
            .setMetastoreUris(DEFAULT_URI)
            .setMetastoreUsername("presto");
    ...
    private static DiscoveryMetastoreLocator createMetastoreLocator(DiscoveryMetastoreConfig config, Map<String, Optional<ThriftMetastoreClient>> clients)
    {
        return new DiscoveryMetastoreLocator(
                config,
                new MockThriftMetastoreClientFactory(Optional.empty(), new Duration(1, SECONDS), clients));
    }
