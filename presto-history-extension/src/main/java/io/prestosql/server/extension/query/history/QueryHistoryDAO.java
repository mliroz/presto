...
public interface QueryHistoryDAO
{
    ...
    @SqlUpdate("DELETE FROM query_history WHERE cluster = :cluster AND id < ( SELECT max(id) FROM query_history ) - 200000")
    int applyRetention(@Bind("cluster") String cluster);
}
